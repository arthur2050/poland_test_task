...
4. You have to do following command php bin/console create-test-data in console when you are in the project directory, through it you will be alble to create fake data.
5. After all of it you have to laucn local symfony server(it's command symfony server:start).
6. Next you have to open route http://127.0.0.1:8000/report. Enjoy application!
